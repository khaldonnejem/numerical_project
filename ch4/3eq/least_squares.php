...
//        echo "<b style='font-size: 20px ;color: darkblue'>[x0,x1,x2,x3] Is : </b>" . "<b style='font-size: 18px'>$r</b>" ;
        ...
        echo "<center><h5 style='color: maroon'> The equation is : <b style='color: black'> $n a0 + $rx a1 +  $xn a2  =$ry </b> </h2></center>";
        echo "<center><h5 style='color: maroon'> The equation 2 is :  <b style='color: black'>  $rx a0 +$xn a1 + $xnn a2 =$xyn </b> </h5></center>";
        echo "<center><h5 style='color: maroon'> The equation 2 is :  <b style='color: black'>  $xn a0 +$xnn a1 + $xm a2 =$xny </b> </h5></center>";
        ...
        echo "<center><h5 style='color: maroon'> The value of a2 =   <b style='color: black'> $a2</b> </h5></center>";
        echo "<center><h5 style='color: maroon'> The value of cc =   <b style='color: black'> $cc</b> </h5></center>";
//        echo "<center><h5 style='color: maroon'> The value of ccv =   <b style='color: black'> $ma2 </b> </h5></center>";

        echo "<center><h3 style='color: maroon'> The value of Y =   <b style='color: black'> $a0 + $a1 X + $a2 X²</b> </h3></center>";
