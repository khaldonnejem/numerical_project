...
<h1 style="font-family: 'Courier New', Courier, monospace;"> <center> False Position  </center></h1>
...
if(isset($_POST['submit'])) {
    ...
    while($flag == false){
        ...
        if($interv1 * $interv2 < 0){
            ...
            // echo" <br>";
           $X2=$first-($interv1*($second-$first))/($interv2-$interv1);
            echo "<p class='line-1 anim-typewriter'>the First root is :".$X2."</p>";

            // echo"<br>";
            $x3 = $X2-(func($X2,$a,$b,$c,$d)*($second-$X2))/($interv2- func($X2,$a,$b,$c,$d));
            echo "<p class='line-1 anim-typewriter'>the Second root is :".$x3. "</p>" ;

            // echo"<br>";
            $x4 = $x3-(func($x3,$a,$b,$c,$d)*($second-$x3))/($interv2-func($x3,$a,$b,$c,$d));
            echo "<p class='line-1 anim-typewriter'>the Third root is :".$x4 . "</p>";
            $flag = true;
            exit;
        }
        else{
